...
typedef AK::WwiseAuthoringAPI::Client Client;
#endif
...
private:
    ...
    static FAkWaapiClient* m_AkWaapiClient;
    Client m_Client;
...
public:
    ...
    // WAAPI JSon Helpers
    //===================================================================================================
    /** Returns a shared reference to a FJsonObject with the requested WAAPI FROM and TRANSFORM itmes. */
